...
//      {country.map((item) =>(
//       <div key={item.population} className='grid grid-cols-1 gap-8 md:grid-cols-2 md:place-items-center md:place-items-center md:h-screen'>
//         <article>
...
//             {item.borders.map((border, index)=>(<Link to={`${item.name.common.replace(/\s+/g, ' ')}`}>
//               <li {...item} key={index} className='bg-white p-2 rounded text-xs tracking-wide shadow  dark:bg-gray-700 dark:text-gray-400 text-gray-700' >{border} </li>
//               </Link>))}
//            </ul>
//            </>
//           )}
